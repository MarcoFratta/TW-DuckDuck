...
<section id="order_details">
    ...
    ?>
                <section>
                    ...
                    <p>Prezzo cad.: &euro;<?php echo number_format((float)(($normal_product['price']/100)), 2, ',', '') ?></p>
                </section>
        <?php endforeach; }?>
    ...
    ?>
                <section>
                    ...
                    <p>Prezzo cad.: &euro;<?php echo number_format((float)(($custom_product['price']/100)), 2, ',', '') ?></p>
                </section>
        <?php endforeach; }?>
